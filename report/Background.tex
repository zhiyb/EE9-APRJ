...
\PARstart{T}{he} Vixen application was based on Microsoft Windows .NET runtime \cite{dotnet}, developed using Microsoft Visual Studio \cite{msvs}. \fref{fig:vixen-main} shows the main application interface.
...
Multiple Linux based systems with a variety of computation resource configurations, including both desktop and embedded platforms, were used for performance testing, as listed in \tref{tbl:linux}.
