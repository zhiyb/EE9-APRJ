...
\begin{figure*}[t]
  ...
  \label{fig:fmts_RPi3}}
  \hfil
  \subfloat[Jetson TX2]{\includegraphics[width=0.66\textwidth]{Figs/fmts-TX2-perf.eps}%
  \label{fig:fmts_TX2}}
