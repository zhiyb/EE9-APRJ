...
# different implementations on the same platform
...
x = x + xspc
set label "Controller unlimited" at character x, y left rotate
...
plot \
	...
	p using ($0):11:10:15:14 lc 1 title " " axes x1y2 with candlesticks whiskerbars, \
	'' using ($0):12:12:12:12 lc 1 lt -1 notitle axes x1y2 with candlesticks, \
	'' using ($0):13 lc 1 pt 2 notitle axes x1y2 with linespoints, \
	c using ($0 + boxoff):17:16:21:20 lc 2 title " " axes x1y2 with candlesticks whiskerbars, \
	'' using ($0 + boxoff):18:18:18:18 lc 2 lt -1 notitle axes x1y2 with candlesticks, \
	'' using ($0 + boxoff):19 lc 2 pt 2 notitle axes x1y2 with linespoints, \
	'' using 0:18:xticlabels(2) lc -1 pt -1 title " " axes x1y2 with points,
