...
\fref{fig:tcplinky_server} shows a screenshot of the server application. It consumes less than $3 \%$ of CPU time under 50 fps refresh rate, which is negligible. It can also be compiled and executed on other computers, simulates real world network connection scenarios.
